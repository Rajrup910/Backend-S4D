...
Mahalanobis source: not computed.
...
Abstention quantiles, the Dirichlet map and the cost-sensitive thresholds were fitted on **val** (`research/predictions_tta`, n=1532); the policy score was selected by AURC on **validation** (n=1532). Fitted state: `research/selective/results_valfit/fit_state.json`.
