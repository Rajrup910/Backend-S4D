...
def write_latex(rows: list[dict], path: Path) -> Path:
    ...
    lines = [
        ...
        # table* + \scriptsize: the cost_sensitive_thresholds row carries two 7-element
        # vectors, ~154 printed characters. In a 252pt single column that overflows by
        # roughly 2.7x; at \scriptsize across the 516pt textwidth it lands near 485pt.
        r"\begin{table*}[t]",
        r"\centering",
        r"\scriptsize",
