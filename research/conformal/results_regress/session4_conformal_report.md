...
`research/conformal/results_regress/fit_state.json` — every conformal quantile, its per-class calibration count and the RAPS hyperparameters, in the form the single test pass consumes.
