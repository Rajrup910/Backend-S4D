...
`research/calibration/results_valfit/fit_state.json` — the calibrator coefficients and decision thresholds this run produced, in the form the single test pass consumes.
