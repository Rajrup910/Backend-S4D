...
%  Appendices
%
%  The reporting checklists and the case atlas, previously shipped as a separate
%  supplementary document and merged in here so the work reads as one artifact.
%  Generated by research/ablation/build_supplementary.py from
...
%
%  \onecolumn is required: longtable cannot break across a two-column page.
% =====================================================================
\clearpage
\onecolumn
\appendices
